...
const defaultGradientStyles = [
    ...
    'from-red-400 via-red-500 to-yellow-400'
];

const RotatingText = forwardRef((props, ref) => {
    const {
        texts,
        gradientStyles = defaultGradientStyles,
    ...
    const [currentGradient, setCurrentGradient] = useState(gradientStyles[0]);
    ...
    const handleIndexChange = useCallback(
        (newIndex) => {
            ...
            const newGradient = gradientStyles[newIndex % gradientStyles.length];
            setCurrentGradient(newGradient);
            if (onGradientChange) onGradientChange(newGradient);
        },
        [onNext, onGradientChange, gradientStyles]
    );
